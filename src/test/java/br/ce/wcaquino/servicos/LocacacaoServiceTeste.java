...
public class LocacacaoServiceTeste {
	...
	@Test
	public void NaodevolverFilmesnoddomingo() throws FilmesSemEestoqueException, LocadoraException {
...
//		assertThat(retorno.getDataRetorno(),new DiasSemanaMatcher(Calendar.MONDAY));
